...
export const Showcase = () => {
    return (
        ...
        <label htmlFor="menu" className="label text-2xl lg:hidden"><i className="fa-solid fa-bars"></i></label>
            ...
            <div className="slider  bg-black flex items-center justify-center">
                <div className="slide flex w-9/12 h-auto items-center justify-center md:flex-row flex-col-reverse py-5"> 
                    <div className="left text-white w-1/2 flex gap-3 flex-col items-start justify-between">
                        ...
                        <h1 className="2xl:text-6xl xl:text-4xl md:text-2xl">Up to 10% off Voucher</h1>
                        <button type="submit" className="flex items-center gap-2 justify-center border-b-2 border-white">Shop now <i className="fa-solid fa-arrow-right"></i></button>
                    </div>
                    <div className="right">
...
export const Card1 = () => {
    ...
    <div className="box">
        ...
        <div className="text2 flex items-center justify-around flex-wrap">
            ...
            <div className="day flex flex-col items-center"><h5>Days</h5><span className="day">03</span></div>
            <div className="hour flex flex-col items-center"><h5>Hour</h5><span className="hour">23</span></div>
            <div className="minutes flex flex-col items-center"><h5>Minutes</h5><span className="minutes">19</span></div>
            <div className="seconds flex flex-col items-center"><h5>Seconds</h5><span className="seconds">56</span></div>
        </div>
        <div className="arrow flex items-center gap-3">
            <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-left"></i></a>
            <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-right"></i></a>
        </div>
        </div>
...
<div className="box1 flex items-center justify-center flex-col">
    ...
    {cards.map((card, index) => (
        <div key={index} className="card w-60 h-72 flex flex-col rounded-lg relative justify-between">
            ...
            <div>
            <h3 className="discount absolute top-3 left-3 bg-red-500 text-white py-1 px-1 rounded">{card.discount}</h3>
            ...
            <div className="price flex items-center justify-start gap-2">
                <span className="price1 text-red-500 font-semibold">{card.price1}</span>
                <span className="price2 text-gray-500 line-through">{card.price2}</span>
            </div>
...
<a href="#" className="bg-red-600 text-white rounded-md w-auto h-auto py-2 px-6 border-2 border-red-600 hover:bg-white hover:text-red-500 font-semibold text-xl transition duration-700">View All Products</a>
</div>
</div>
)}
...
return (
    <div className="box2">
         <div className="text2 flex items-center justify-start ml-6 mt-6 gap-3 pt-6 flex-wrap">
            <span className="bg-red-500 h-10 w-5 rounded"></span>
            <span className="text-red-500 text-3xl font-semibold">Categories
            </span>
        </div>
        <div className="text2 flex items-center justify-around flex-wrap">
            <h2 className="text-black text-3xl font-semibold">Browse By Category</h2>
        <div className="arrow flex items-center gap-3">
            <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-left"></i></a>
            <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-right"></i></a>
        </div>
...
export const Card3 = () => {
    ...
    return(
        ...
        <div className="text2 flex items-center justify-around flex-wrap">
            <h2 className="text-black text-3xl font-semibold">Best Selling Products</h2>
        <div className="button flex items-center gap-3">
            <a href="#" className="bg-red-600 text-white rounded-md w-auto h-auto py-2 px-6 border-2 border-red-600 hover:bg-white hover:text-red-500 font-semibold text-xl transition duration-700">View All</a>
        </div>
        </div>
        <div className="cards flex flex-wrap gap-5 justify-center items-center mb-10 mt-10">
    {cards.map((card, index) => (
        <div key={index} className="card w-60 h-72 flex flex-col rounded-lg relative justify-between">
            ...
            <div>
            <h3 className="discount absolute top-10 right-3 py-1 px-1 rounded"><i className="fa-regular fa-eye"></i></h3>
            <h3 className="like text-gray-500 text-lg absolute right-4 top-2 text-xl">
                <i className="fa-regular fa-heart"></i>
            </h3>
            <h3 className="title font-semibold text-lg mt-2">{card.title}</h3>
...
import advertisementImg from "./images/advertisement-img.png"
    ...
    return(
        ...
        <div className="advertisement bg-black text-white w-3/4 h-auto flex lg:items-center lg:justify-between lg:px-14 py-3 rounded-lg lg:flex-row flex-col-reverse items-center justify-center">
            <div className="left w-1/2 flex gap-5 flex-col lg:items-start lg:justify-center items-center">
                ...
                <h1 className="xl:text-5xl lg:text-3xl sm:text-xl text-base text-center lg:text-start">Enhance Your Music Experience</h1>
                ...
                <a href ="#" className="text-white bg-green-500 rounded-md w-40 h-auto py-3 px-10 text-xl">Buy Now</a>
            </div>
...
export const Card4 = () => {
    ...
    return (
        <div className="box4">
            <div className="text3 flex items-center justify-start ml-6 mt-6 gap-3 pt-6 flex-wrap">
                <span className="bg-red-500 h-10 w-5 rounded"></span>
                <span className="text-red-500 text-3xl font-semibold">Our Products</span>
            </div>
            <div className="text2 flex items-center justify-around flex-wrap">
                <h2 className="text-black text-3xl font-semibold">Explore Our Products</h2>
                <div className="arrow flex items-center gap-3">
                    <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-left"></i></a>
                    <a href="#" className="w-12 h-auto border-2 border-gray-900 rounded-2xl py-1 px-3"><i className="fa-solid fa-arrow-right"></i></a>
                </div>
        ...
        <div className="box5 flex gap-5 justify-center flex-wrap">
            ...
            <div className="card_text text-white absolute bottom-12 left-10">
                ...
                <div className="button flex gap-2 border-b-2 border-white w-24 items-center">
                    <a href="#" className="">Shop Now</a><i className="fa-solid fa-arrow-right"></i>
                    </div>
            </div>
            </div>
...
export const Card6 = () => {
    ...
    return(
        ...
        {cards.map((card, index) => (
        <div key={index} className="flex flex-col items-center justify-center w-60 py-3 border-2 border-black hover:bg-red-500 hover:text-white transition duration-500 rounded-md">
