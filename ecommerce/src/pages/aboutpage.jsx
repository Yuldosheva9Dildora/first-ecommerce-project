...
function About() {
  return (
    <div>
      {" "}
      <h1 className="flex mt-[70px] text-gray-400 ml-[190px] mb-[-90px]">
        ...
        <div className="story">
          <div className="storycontent">
            ...
            <div className="storyimg">
              <img src="/assets/SideImage.png" alt="about" />{" "}
            </div>
          </div>
          <div className="card">
            <div className="cards">
          ...
          <div className="people">
            <div className="person">
              <div className="personimg">
                <img src="/assets/firstface.png" alt="first" />
              </div>
              <h1>Tom Cruise</h1>
            ...
            <div className="person">
              <div className="personimg">
                <img src="/assets/secondface.png" alt="second" />
              </div>
              <h1>Emma Watson</h1>
            ...
            <div className="person">
              <div className="personimg">
                <img src="/assets/thirdface.png" alt="third" />
              </div>
              <h1>Will Smith</h1>
